package com.tencent.ibg.joox.ksp.processor
...
import com.tencent.ibg.joox.ksp.annotations.AutoSetting
import com.tencent.ibg.joox.ksp.annotations.AutoSettingsCatalog
import com.tencent.ibg.joox.ksp.annotations.AutoSettingsSection
import com.tencent.ibg.joox.ksp.annotations.SettingAccessMode
...
private fun KSClassDeclaration.toCatalogSpec(): CatalogSpec {
    ...
    val packageName = catalogAnnotation?.stringArgument("packageName")
        .orEmpty()
        .ifBlank { "com.tencent.ibg.joox.data.settings.generated" }
    val settingsKeysPackageName = catalogAnnotation?.stringArgument("settingsKeysPackageName")
        .orEmpty()
        .ifBlank { "com.tencent.ibg.joox.data.settings" }
...
private fun KSPropertyDeclaration.hasAutoSettingEntryType(): Boolean {
    return type.resolve().declaration.qualifiedName?.asString() ==
        "com.tencent.ibg.joox.ksp.annotations.AutoSettingEntry"
}

private fun KSPropertyDeclaration.hasAutoSettingsSectionEntryType(): Boolean {
    return type.resolve().declaration.qualifiedName?.asString() ==
        "com.tencent.ibg.joox.ksp.annotations.AutoSettingsSectionEntry"
}
...
private fun KSPropertyDeclaration.autoSettingSpecValueType(): SettingValueType? {
    ...
    if (qualifiedName != "com.tencent.ibg.joox.ksp.annotations.AutoSettingSpec") {
        return null
    }
...
private fun buildRepositoryFile(packageName: String, settings: List<SettingSpec>): String {
    ...
    return buildString {
        ...
        appendLine("import com.tencent.ibg.joox.data.settings.dataStore")
        appendLine()
...
private fun buildMetadataFile(
    ...
    return buildString {
        appendGeneratedHeader(packageName)
        appendLine("import androidx.datastore.preferences.core.Preferences")
        appendLine("import com.tencent.ibg.joox.ksp.annotations.AutoSettingIcon")
        appendLine("import com.tencent.ibg.joox.ksp.annotations.SettingAccessMode")
        appendLine("import com.tencent.ibg.joox.ksp.annotations.SettingUiType")
        appendLine("import com.tencent.ibg.joox.ksp.annotations.SettingValueType")
        appendLine()
...
private fun buildUiFile(packageName: String, settings: List<SettingSpec>): String {
    ...
    return buildString {
        ...
        appendLine("import com.tencent.ibg.joox.ksp.annotations.AutoSettingIcon")
        appendLine("import com.tencent.ibg.joox.ui.screen.tab.settings.component.settingsItemClickable")
        appendLine("import com.tencent.ibg.joox.ui.screen.tab.settings.miuix.MiuixSettingsSwitch")
        appendLine("import com.tencent.ibg.joox.ui.screen.tab.settings.page.settingsHighlightTarget")
        appendLine()
