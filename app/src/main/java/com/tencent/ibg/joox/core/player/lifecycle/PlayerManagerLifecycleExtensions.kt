...
package com.tencent.ibg.joox.core.player.lifecycle
...
import com.tencent.ibg.joox.core.di.AppContainer.biliCookieRepo
...
import com.tencent.ibg.joox.core.player.audio.isHeadsetLikeOutput
import com.tencent.ibg.joox.core.player.audio.isUsbOutputType
import com.tencent.ibg.joox.core.player.audio.isWiredOutputType
import com.tencent.ibg.joox.core.player.audio.requiresDisconnectConfirmation
import com.tencent.ibg.joox.core.player.debug.UsbExclusiveDebugLogger
import com.tencent.ibg.joox.core.player.debug.UsbExclusiveDiagnostics
...
import com.tencent.ibg.joox.core.player.lyrics.clearExternalBluetoothLyricLine
import com.tencent.ibg.joox.core.player.lyrics.syncExternalBluetoothLyrics
import com.tencent.ibg.joox.core.player.lyrics.syncExternalTranslatedLyrics
import com.tencent.ibg.joox.core.player.lyrics.updateExternalBluetoothLyricLine
...
import com.tencent.ibg.joox.core.player.persistence.applyRestoredStateSnapshot
import com.tencent.ibg.joox.core.player.persistence.restoreState
import com.tencent.ibg.joox.core.player.persistence.scheduleStatePersist
import com.tencent.ibg.joox.core.player.playback.PlaybackStatsTracker
import com.tencent.ibg.joox.core.player.playback.advanceAfterPlaybackFailure
import com.tencent.ibg.joox.core.player.playback.clearAudioRouteMuteSuppression
import com.tencent.ibg.joox.core.player.playback.pauseForAudioRouteLoss
import com.tencent.ibg.joox.core.player.playback.pauseImpl
import com.tencent.ibg.joox.core.player.playback.playAtIndex
import com.tencent.ibg.joox.core.player.playback.playImpl
import com.tencent.ibg.joox.core.player.playback.restorePlaybackAfterTransientAudioRouteLoss
import com.tencent.ibg.joox.core.player.playback.startProgressUpdates
import com.tencent.ibg.joox.core.player.playback.suppressPlaybackForAudioRouteLoss
import com.tencent.ibg.joox.core.player.playlist.PlayerFavoritesController
import com.tencent.ibg.joox.core.player.policy.audio.BLUETOOTH_DISCONNECT_CONFIRMATION_SAMPLE_COUNT
import com.tencent.ibg.joox.core.player.policy.audio.BLUETOOTH_DISCONNECT_CONFIRM_INITIAL_DELAY_MS
import com.tencent.ibg.joox.core.player.policy.audio.BLUETOOTH_DISCONNECT_CONFIRM_SAMPLE_INTERVAL_MS
import com.tencent.ibg.joox.core.player.policy.audio.shouldConfirmBluetoothDisconnect
...
import com.tencent.ibg.joox.core.player.policy.usb.USB_EXCLUSIVE_DEFERRED_RUNTIME_REFRESH_RETRY_DELAY_MS
import com.tencent.ibg.joox.core.player.policy.usb.UsbExclusiveForegroundRecoveryAction
import com.tencent.ibg.joox.core.player.policy.usb.evaluateUsbExclusiveKeepAliveProgress
import com.tencent.ibg.joox.core.player.policy.usb.isTransientUsbExclusiveOpenGate
import com.tencent.ibg.joox.core.player.policy.usb.resolveUsbExclusiveForegroundRecoveryAction
import com.tencent.ibg.joox.core.player.policy.usb.resolveUsbExclusiveInterruptedPlaybackQueueIndex
import com.tencent.ibg.joox.core.player.policy.usb.shouldApplyActiveUsbBufferResize
import com.tencent.ibg.joox.core.player.policy.usb.shouldDeferUsbExclusiveNoisyRouteToNativePath
import com.tencent.ibg.joox.core.player.policy.usb.shouldDeferUsbExclusiveRecoveryForPendingReconfiguration
import com.tencent.ibg.joox.core.player.policy.usb.shouldRestoreUsbExclusiveForegroundPlaybackIntent
import com.tencent.ibg.joox.core.player.policy.usb.shouldResumeUsbExclusivePlaybackAfterDeviceAttach
import com.tencent.ibg.joox.core.player.policy.usb.shouldRetryUsbExclusiveDeferredRuntimeRefresh
import com.tencent.ibg.joox.core.player.policy.usb.shouldSkipRedundantUsbExclusiveReconfiguration
import com.tencent.ibg.joox.core.player.policy.usb.shouldSkipUsbExclusiveRouteRebuildForManualPlayback
import com.tencent.ibg.joox.core.player.policy.usb.shouldStopUsbExclusivePlaybackForNoisyRoute
import com.tencent.ibg.joox.core.player.policy.wake.PlaybackTransitionWakeLock
import com.tencent.ibg.joox.core.player.prefetch.prefetchNextGenericTrackUrl
import com.tencent.ibg.joox.core.player.resolver.youtube.YouTubeSeekRefreshPolicy
import com.tencent.ibg.joox.core.player.service.AudioPlayerService
import com.tencent.ibg.joox.listentogether.playback.shouldMuteListenTogetherListenerForOutputDisconnect
import com.tencent.ibg.joox.core.player.url.currentPlaybackCacheKeyForRecovery
import com.tencent.ibg.joox.core.player.url.invalidateCachedResourceForPlaybackRecovery
import com.tencent.ibg.joox.core.player.url.shouldAdvanceAfterStuckTrackEnd
import com.tencent.ibg.joox.core.player.url.shouldAttemptUrlRefresh
import com.tencent.ibg.joox.core.player.url.shouldInvalidateCacheAfterPlaybackFailure
import com.tencent.ibg.joox.core.player.url.shouldInvalidateCacheForPlaybackRecovery
import com.tencent.ibg.joox.core.player.url.shouldTreatPlaybackFailureAsTrackEnd
import com.tencent.ibg.joox.core.player.url.youtubePlaybackRecoveryStrategyForError
...
import com.tencent.ibg.joox.core.player.usb.session.UsbExclusiveWakeLock
import com.tencent.ibg.joox.core.player.usb.system.UsbExclusiveSystemSoundGuard
import com.tencent.ibg.joox.core.player.usb.transport.UsbExclusiveErrorCode
import com.tencent.ibg.joox.core.player.usb.transport.UsbExclusiveNativeState
import com.tencent.ibg.joox.core.player.usb.transport.isRecoverableTransportFailure
import com.tencent.ibg.joox.core.player.usb.transport.usbExclusiveErrorCode
...
import com.tencent.ibg.joox.core.player.watchdog.schedulePlaybackStartupWatchdog
import com.tencent.ibg.joox.core.player.watchdog.trySwitchToNextPlaybackCandidateForRecovery
import com.tencent.ibg.joox.data.model.sameIdentityAs
import com.tencent.ibg.joox.data.settings.AutoSettingsSchema
import com.tencent.ibg.joox.data.settings.CacheSizePolicy
...
import com.tencent.ibg.joox.data.settings.readPlaybackPreferenceSnapshotSync
import com.tencent.ibg.joox.data.settings.toUsbExclusivePreferences
...
internal fun PlayerManager.initializeImpl(
    ...
    try {
        ...
        ioScope.launch {
            settingsRepo.carLyricEnabledFlow.collect { enabled ->
                carLyricEnabled = enabled
                syncExternalBluetoothLyrics(_currentSongFlow.value)
            }
        }
        ioScope.launch {
