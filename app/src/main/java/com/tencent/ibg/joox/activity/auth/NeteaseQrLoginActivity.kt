...
import com.tencent.ibg.joox.core.api.netease.NeteaseQrLoginClient
...
class NeteaseQrLoginActivity : ComponentActivity() {
    ...
    private suspend fun pollQrLogin(session: com.tencent.ibg.joox.core.api.netease.NeteaseQrLoginSession) {
