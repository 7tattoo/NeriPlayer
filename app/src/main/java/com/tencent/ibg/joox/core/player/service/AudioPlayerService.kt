package com.tencent.ibg.joox.core.player.service
 ...
 *
 * File: com.tencent.ibg.joox.core.player.service/AudioPlayerService
 * Updated: 2026/3/23
 */
...
import com.tencent.ibg.joox.activity.MainActivity
import com.tencent.ibg.joox.activity.shouldProcessUsbDeviceAttachedAction
...
import com.tencent.ibg.joox.core.player.PlayerManager.externalBluetoothLyricLineFlow
...
import com.tencent.ibg.joox.core.player.policy.usb.shouldRunUsbExclusiveBackgroundAudioAnchor
import com.tencent.ibg.joox.core.player.policy.usb.UsbExclusiveKeepAliveProgress
...
import com.tencent.ibg.joox.core.player.usb.system.UsbExclusiveBackgroundAudioAnchor
import com.tencent.ibg.joox.core.player.usb.system.UsbExclusiveSystemVolumeBridge
...
import com.tencent.ibg.joox.core.startup.safemode.SafeModeManager
...
import com.tencent.ibg.joox.data.settings.PlaybackServiceIdleShutdownPreference
import com.tencent.ibg.joox.data.settings.readPlaybackPreferenceSnapshot
import com.tencent.ibg.joox.data.traffic.isOfflineModeNow
...
import com.tencent.ibg.joox.util.media.IsLandHelp
import com.tencent.ibg.joox.util.media.buildRemoteSongShareUrl
import com.tencent.ibg.joox.util.media.isShareablePublicHttpUrl
import com.tencent.ibg.joox.util.media.offlineCachedImageRequest
import com.tencent.ibg.joox.widget.playbackWidgetPresentationChanged
import com.tencent.ibg.joox.widget.playbackWidgetProgressRefreshBucket
import com.tencent.ibg.joox.widget.PlaybackWidgetState
import com.tencent.ibg.joox.widget.PlaybackWidgetUpdater
import com.tencent.ibg.joox.widget.buildPlaybackWidgetState
import com.tencent.ibg.joox.widget.shouldPartiallyUpdatePlaybackWidgetProgress
...
class AudioPlayerService : MediaBrowserService() {
    ...
    companion object {
        ...
        const val ACTION_PAUSE = "com.tencent.ibg.joox.action.PAUSE"
        const val ACTION_RESTORE_VOLUME = "com.tencent.ibg.joox.action.RESTORE_VOLUME"
        const val ACTION_TOGGLE_PLAY_PAUSE =
            "com.tencent.ibg.joox.action.TOGGLE_PLAY_PAUSE"
        const val ACTION_STOP = "com.tencent.ibg.joox.action.STOP"
        const val ACTION_NEXT = "com.tencent.ibg.joox.action.NEXT"
        const val ACTION_PREV = "com.tencent.ibg.joox.action.PREV"
        const val ACTION_SYNC = "com.tencent.ibg.joox.action.SYNC"
        const val ACTION_TOGGLE_FAV = "com.tencent.ibg.joox.action.TOGGLE_FAVORITE"
        const val ACTION_TOGGLE_FLOATING_LYRICS =
            "com.tencent.ibg.joox.action.TOGGLE_FLOATING_LYRICS"
        private const val LEGACY_ACTION_HIDE_FLOATING_LYRICS =
            "com.tencent.ibg.joox.action.HIDE_FLOATING_LYRICS"
    ...
    private fun updateMetadata() {
        ...
        val useBluetoothLyrics = shouldUseExternalBluetoothLyrics(
            ...
            // 车载歌词优先：开启时灵动岛停止覆盖 TITLE/ARTIST，
            // 车载歌词走自定义键（ucar/extras/vivomusicmix），避免 TITLE 冲突
            forceSendLyrics = PlayerManager.dynamicIslandLyricsEnabled &&
                !PlayerManager.carLyricEnabled
        )
