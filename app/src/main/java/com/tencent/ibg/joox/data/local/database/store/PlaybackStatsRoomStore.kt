...
import com.tencent.ibg.joox.data.stats.PlaybackStatBucket
import com.tencent.ibg.joox.data.stats.PlaybackStatsSyncCounterSnapshot
...
internal class PlaybackStatsRoomStore(
    ...
    private fun metadata(key: String, value: String, now: Long) =
        com.tencent.ibg.joox.data.local.database.entity.MigrationMetadataEntity(
            key = key,
            value = value,
            updatedAt = now
        )
