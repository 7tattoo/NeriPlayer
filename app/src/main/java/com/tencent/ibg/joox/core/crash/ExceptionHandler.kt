package com.tencent.ibg.joox.core.crash
 ...
 *
 * File: com.tencent.ibg.joox.util/ExceptionHandler
 * Created: 2025/1/27
 */
...
object ExceptionHandler {
    ...
    fun handleException(source: String, throwable: Throwable, isUncaught: Boolean = false) {
        ...
        val exceptionInfo = buildString {
            ...
            appendLine("App Version: ${com.tencent.ibg.joox.BuildConfig.VERSION_NAME}")
            appendLine("Build Type: ${com.tencent.ibg.joox.BuildConfig.BUILD_TYPE}")
            appendLine("Build UUID: ${com.tencent.ibg.joox.BuildConfig.BUILD_UUID}")
        }
