...
import com.tencent.ibg.joox.data.local.database.entity.SyncOutboxStatus
import com.tencent.ibg.joox.data.local.playlist.model.LocalPlaylist
import com.tencent.ibg.joox.data.local.playlist.LocalPlaylistSyncMutationOutbox
        ...
        database.withTransaction {
            ...
            database.syncMetadataDao().upsertMigrationMetadata(
                migrationMetadata(
                    ...
                    com.tencent.ibg.joox.data.local.database.entity
            ...
            mutations = entries.mapNotNull { entry ->
                runCatching {
                    gson.fromJson(
                        ...
                        com.tencent.ibg.joox.data.local.playlist.LocalPlaylistSyncMutation::class.java
                    )
                }.getOrNull()
            }
