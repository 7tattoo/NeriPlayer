...
import com.tencent.ibg.joox.ui.component.lyrics.flattenWordTimedEntries as newFlattenWordTimedEntries
import com.tencent.ibg.joox.ui.component.lyrics.hasWordTimedEntries as newHasWordTimedEntries
import com.tencent.ibg.joox.ui.component.lyrics.toEditableLyricsText as newToEditableLyricsText
import com.tencent.ibg.joox.ui.component.lyrics.verticalEdgeFade as newVerticalEdgeFade
import com.tencent.ibg.joox.data.model.SongItem

typealias LyricVisualSpec = com.tencent.ibg.joox.ui.component.lyrics.LyricVisualSpec
typealias WordTiming = com.tencent.ibg.joox.ui.component.lyrics.WordTiming
typealias LyricEntry = com.tencent.ibg.joox.ui.component.lyrics.LyricEntry
typealias LyricSeekHapticFeedback = com.tencent.ibg.joox.ui.component.lyrics.LyricSeekHapticFeedback
internal typealias LyricsEditorSeed = com.tencent.ibg.joox.ui.component.lyrics.LyricsEditorSeed
internal typealias HeadGlowTarget = com.tencent.ibg.joox.ui.component.lyrics.HeadGlowTarget
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "com.tencent.ibg.joox.ui.component.lyrics.SyncedLyricsView"
    )
)
@Composable
fun AppleMusicLyric(
...
fun AdvancedLyricsView(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.AdvancedLyricsView(
        lyrics = lyrics,
        currentTimeMs = currentTimeMs,
        modifier = modifier,
        textColor = textColor,
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "com.tencent.ibg.joox.ui.component.lyrics.SyncedLyricsActiveLine"
    )
)
@Composable
...
fun DebugActiveLine(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.DebugActiveLine(
        line = line,
        currentTimeMs = currentTimeMs,
        activeColor = activeColor,
        inactiveColor = inactiveColor,
...
fun isNeteaseYrc(content: String): Boolean =
    com.tencent.ibg.joox.ui.component.lyrics.isNeteaseYrc(content)

fun parseNeteaseLyricsAuto(content: String): List<LyricEntry> =
    com.tencent.ibg.joox.ui.component.lyrics.parseNeteaseLyricsAuto(content)

fun calculateLineProgress(line: LyricEntry, currentTimeMs: Long): Float =
    com.tencent.ibg.joox.ui.component.lyrics.calculateLineProgress(line, currentTimeMs)

fun findCurrentLineIndex(lines: List<LyricEntry>, currentTimeMs: Long): Int =
    com.tencent.ibg.joox.ui.component.lyrics.findCurrentLineIndex(lines, currentTimeMs)

fun parseNeteaseYrc(yrc: String): List<LyricEntry> =
    com.tencent.ibg.joox.ui.component.lyrics.parseNeteaseYrc(yrc)

fun parseNeteaseLrc(lrc: String): List<LyricEntry> =
    com.tencent.ibg.joox.ui.component.lyrics.parseNeteaseLrc(lrc)
...
fun resolvePreferredLyricContent(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.resolvePreferredLyricContent(
...
internal fun resolveStoredLyricText(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.resolveStoredLyricText(
...
internal fun resolveLyricsEditorInitialText(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.resolveLyricsEditorInitialText(
        matchedLyric = matchedLyric,
        preferredNeteaseLyric = preferredNeteaseLyric,
...
internal fun resolveLyricsEditorSeed(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.resolveLyricsEditorSeed(
        song = song,
...
internal fun matchTranslationsToLineIndices(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.matchTranslationsToLineIndices(
        lines = lines,
...
internal fun findBestMatchingTranslation(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.findBestMatchingTranslation(
        translations = translations,
...
internal fun shouldSnapLyricTimeSmoothing(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.shouldSnapLyricTimeSmoothing(
...
internal fun lyricListItemKey(index: Int, line: LyricEntry): String =
    com.tencent.ibg.joox.ui.component.lyrics.lyricListItemKey(index, line)
...
internal fun resolveHeadGlowTarget(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.resolveHeadGlowTarget(
...
fun buildPhoneticLyricEntries(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.buildPhoneticLyricEntries(
        rawLyrics = rawLyrics,
        lyrics = lyrics
    )
...
fun rememberLyricSeekHapticFeedback(
    lyrics: List<LyricEntry>,
    lyricOffsetMs: Long = 0L
): com.tencent.ibg.joox.ui.component.lyrics.LyricSeekHapticFeedback =
    com.tencent.ibg.joox.ui.component.lyrics.rememberLyricSeekHapticFeedback(
        lyrics = lyrics,
        lyricOffsetMs = lyricOffsetMs
    )
...
fun LyricShareSheet(
    ...
    com.tencent.ibg.joox.ui.component.lyrics.LyricShareSheet(
        song = song,
        lyrics = lyrics,
