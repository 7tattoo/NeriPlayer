 ...
 *
 * File: com.tencent.ibg.joox.data.sync.github/GitHubSyncManager
 * Updated: 2026/3/23
 */
...
import com.tencent.ibg.joox.data.sync.github.SyncDataChangeDetector
import com.tencent.ibg.joox.data.sync.github.SyncDataSerializer
import com.tencent.ibg.joox.data.sync.github.SyncPlaybackStatMapper
import com.tencent.ibg.joox.data.sync.github.SyncPlaybackStatsMergePolicy
import com.tencent.ibg.joox.data.sync.github.SyncPlaylistUsageStatsMergePolicy
import com.tencent.ibg.joox.data.sync.github.SyncPlaylistDeletionPolicy
import com.tencent.ibg.joox.data.sync.github.SyncPlaylistSongMergePolicy
import com.tencent.ibg.joox.data.sync.github.LocalSyncMutationConflictException
import com.tencent.ibg.joox.data.sync.github.SyncUploadRetryExecutor
import com.tencent.ibg.joox.data.sync.model.ConflictResolution
import com.tencent.ibg.joox.data.sync.model.ConflictType
import com.tencent.ibg.joox.data.sync.model.CURRENT_SYNC_METADATA_VERSION
import com.tencent.ibg.joox.data.sync.model.SyncConflict
import com.tencent.ibg.joox.data.sync.model.SyncData
import com.tencent.ibg.joox.data.sync.model.SyncBiliVideoSkipMergePolicy
import com.tencent.ibg.joox.data.sync.model.SyncFavoritePlaylist
import com.tencent.ibg.joox.data.sync.model.SyncPlaybackStatBucket
import com.tencent.ibg.joox.data.sync.model.SyncPlaylist
import com.tencent.ibg.joox.data.sync.model.SyncPlaylistSongDeletion
import com.tencent.ibg.joox.data.sync.model.SyncRecentPlay
import com.tencent.ibg.joox.data.sync.model.SyncRecentPlayDeletion
import com.tencent.ibg.joox.data.sync.model.SyncResult
import com.tencent.ibg.joox.data.sync.model.SyncSong
import com.tencent.ibg.joox.data.sync.model.SyncTrackStat
import com.tencent.ibg.joox.data.sync.model.copyWithNormalizedMembershipTokens
import com.tencent.ibg.joox.data.sync.model.hasResolvableSyncIdentity
import com.tencent.ibg.joox.data.sync.model.mergePositiveTimestamp
import com.tencent.ibg.joox.data.sync.model.sanitizeCoverUrlForSync
import com.tencent.ibg.joox.data.sync.model.sanitizeCoverUrlsForSync
import com.tencent.ibg.joox.data.sync.model.toBiliVideoSkipRuleOrNull
import com.tencent.ibg.joox.data.sync.model.toSyncBiliVideoSkipRule
import com.tencent.ibg.joox.data.stats.PlaybackStatsRepository
import com.tencent.ibg.joox.data.sync.SyncCoordinator
...
class WebDavSyncManager private constructor(context: Context) {
    ...
    private fun mergeLocalOnlySongs(
        syncedSongs: List<com.tencent.ibg.joox.data.model.SongItem>,
        localOnlySongs: List<com.tencent.ibg.joox.data.model.SongItem>
    ): MutableList<com.tencent.ibg.joox.data.model.SongItem> {
