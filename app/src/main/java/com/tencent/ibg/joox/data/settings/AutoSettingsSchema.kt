...
import com.tencent.ibg.joox.core.player.download.DEFAULT_DOWNLOAD_PARALLELISM
...
import com.tencent.ibg.joox.ksp.annotations.autoFloatSetting
import com.tencent.ibg.joox.ksp.annotations.autoIntSetting
import com.tencent.ibg.joox.ksp.annotations.autoSetting
import com.tencent.ibg.joox.ksp.annotations.autoSettingsSection
import com.tencent.ibg.joox.ksp.annotations.autoStringSetting
import com.tencent.ibg.joox.ksp.annotations.autoSwitchSetting
...
object AutoSettingsSchema {
    ...
    object lyrics {
        ...
        @AutoSetting(
            key = "car_lyric_enabled",
            type = SettingValueType.Boolean,
            defaultBoolean = true,
            order = 29,
            ui = SettingUiType.Switch
        )
        val carLyricEnabled = autoSwitchSetting(
            key = "car_lyric_enabled",
            defaultValue = true,
            titleRes = R.string.settings_car_lyric_enabled,
            descriptionRes = R.string.settings_car_lyric_enabled_desc,
            icon = AutoSettingIcon.BluetoothAudio
        )
