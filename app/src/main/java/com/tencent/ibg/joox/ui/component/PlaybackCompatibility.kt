...
typealias NeriMiniPlayerDefaults = com.tencent.ibg.joox.ui.component.playback.NeriMiniPlayerDefaults
typealias PlaybackSourceType = com.tencent.ibg.joox.ui.component.playback.PlaybackSourceType
...
fun NeriMiniPlayer(
    ...
    com.tencent.ibg.joox.ui.component.playback.NeriMiniPlayer(
        title = title,
        artist = artist,
        coverUrl = coverUrl,
        isPlaying = isPlaying,
...
fun PlaybackSoundSheet(
    ...
    com.tencent.ibg.joox.ui.component.playback.PlaybackSoundSheet(
        state = state,
...
fun PlaybackSourceBadge(
    ...
    com.tencent.ibg.joox.ui.component.playback.PlaybackSourceBadge(
        source = source,
        modifier = modifier
    )
}
...
fun SleepTimerDialog(
    ...
    com.tencent.ibg.joox.ui.component.playback.SleepTimerDialog(onDismiss = onDismiss)
}
...
fun WaveformSlider(
    ...
    com.tencent.ibg.joox.ui.component.playback.WaveformSlider(
        value = value,
